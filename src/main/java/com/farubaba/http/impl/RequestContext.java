...
import com.farubaba.http.body.Body;
import com.farubaba.http.model.ErrorResultType;
...
public class RequestContext<M extends IModel> implements IRequestContext {
	...
	public RequestContext<M> setResultModelClass(Class<M> resultModelClass) {
	...
	public RequestContext<M> setCallback(RequestCallback<M> callback) {
